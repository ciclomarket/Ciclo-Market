...
app.get('/api/market/search', async (req, res) => {
  try {
    ...
    // Normalizar criterios similar a búsquedas guardadas
    const rawCriteria = {
      cat: req.query.cat,
    ...
    for (const listing of items) {
      ...
      // Filtro "Sólo tiendas oficiales" adicional por consistencia (ya aplicado en criteria.store)
    ...
    } // 'relevance' preserva el orden base
